...
function add_css() {
  ...
  wp_register_style('main', get_template_directory_uri() . '/css/main.css', array('reset_css'), null, 'all');
  wp_enqueue_style('main');

  wp_register_style('stefano', get_template_directory_uri() . '/css/stefano.css', array('reset_css', 'main'), null, 'all');
  wp_enqueue_style('stefano');

  wp_register_style('daniele', get_template_directory_uri() . '/css/daniele.css', array('reset_css', 'main', 'stefano'), null, 'all');
  wp_enqueue_style('daniele');

  wp_register_style('elena', get_template_directory_uri() . '/css/elena.css', array('reset_css', 'main', 'stefano', 'daniele'), null, 'all');
  wp_enqueue_style('elena');

  // È possibile anche aggiungere un url remoto (es. Google Fonts)
  wp_register_style('owlCarouselCSS', 'https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.1.3/assets/owl.carousel.min.css', array('reset_css', 'main', 'stefano', 'daniele', 'elena'), null, 'all');
...
function add_js() {
  ...
  wp_register_script('owlCarousel', 'https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.1.3/owl.carousel.min.js', array('jquery', 'main_js'), null, true);
  wp_enqueue_script('owlCarousel');

  wp_register_script('fontAwsome', 'https://use.fontawesome.com/826a7e3dce.js', array('jquery', 'main_js', 'owlCarousel'), null, true);
