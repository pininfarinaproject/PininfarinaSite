...
if (file_exists(dirname(__FILE__)  . '/local_config.php')) {
  $defaultConfig = $BKAP_apiConfig;
  require_once (dirname(__FILE__)  . '/local_config.php');
  $BKAP_apiConfig = array_merge($defaultConfig, $BKAP_apiConfig);
}
...
class Google_Client {
  ...
  public function __construct($config = array()) {
    global $BKAP_apiConfig;
    $BKAP_apiConfig = array_merge($BKAP_apiConfig, $config);
    self::$cache = new $BKAP_apiConfig['cacheClass']();
    self::$auth = new $BKAP_apiConfig['authClass']();
    self::$io = new $BKAP_apiConfig['ioClass']();
  }
  ...
  public function addService($service, $version = false) {
    ...
    if (isset($BKAP_apiConfig['services'][$service])) {
      // Merge the service descriptor with the default values
      $this->services[$service] = array_merge($this->services[$service], $BKAP_apiConfig['services'][$service]);
    }
  }
  ...
  public function setApplicationName($applicationName) {
    global $BKAP_apiConfig;
    $BKAP_apiConfig['application_name'] = $applicationName;
  }
  ...
  public function setClientId($clientId) {
    global $BKAP_apiConfig;
    $BKAP_apiConfig['oauth2_client_id'] = $clientId;
  ...
  public function setClientSecret($clientSecret) {
    global $BKAP_apiConfig;
    $BKAP_apiConfig['oauth2_client_secret'] = $clientSecret;
  ...
  public function setRedirectUri($redirectUri) {
    global $BKAP_apiConfig;
    $BKAP_apiConfig['oauth2_redirect_uri'] = $redirectUri;
  ...
  public function setUseObjects($useObjects) {
    global $BKAP_apiConfig;
    $BKAP_apiConfig['use_objects'] = $useObjects;
  }
