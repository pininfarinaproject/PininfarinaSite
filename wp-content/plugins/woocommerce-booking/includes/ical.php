...
DTSTART:<?php echo ( bkap_get_dateToCal( $_GET[ 'event_date_start' ] ) )."\n"; ?>
DTEND:<?php echo ( bkap_get_dateToCal( $_GET[ 'event_date_end' ] ) )."\n"; ?>
DTSTAMP:<?php echo ( bkap_get_dateToCal( $_GET[ 'current_time' ] ) )."\n"; ?>
UID:<?php echo ( uniqid() )."\n"; ?>
DESCRIPTION:<?php echo ( bkap_get_escapeString( $_GET[ 'description' ] ) )."\n"; ?>
SUMMARY:<?php echo ( bkap_get_escapeString( $_GET[ 'summary' ] ) )."\n"; ?>
END:VEVENT
END:VCALENDAR
<?php 
exit;
