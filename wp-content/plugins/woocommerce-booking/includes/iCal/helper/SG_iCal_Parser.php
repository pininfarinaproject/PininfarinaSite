...
class SG_iCal_Parser {
	 ...
	 * @param SG_iCal $ical
	 */
	public static function Parse( $url, BKAP_iCal $ical ) {
	 ...
	 * @param SG_iCal $ical
	 */
	public static function ParseString($content, BKAP_iCal $ical ) {
		$content = self::UnfoldLines($content);
		self::_Parse( $content, $ical );
	}
	 ...
	 * @param SG_iCal $ical
	 */
	private static function _Parse( $content, BKAP_iCal $ical ) {
	 ...
	 * @param SG_iCal $ical
	 */
	protected static function storeSection( $section, $data, BKAP_iCal $ical ) {
