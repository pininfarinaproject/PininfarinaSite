 ...
 */
class BKAP_Google_Logger_Psr extends BKAP_Google_Logger_Abstract
{
  /**
   ...
   */
  public function __construct(BKAP_Google_Client $client, /*Psr\Log\LoggerInterface*/ $logger = null)
  {
