...
class BKAP_Google_Config
{
  ...
  public function __construct($ini_file_location = null)
  {
    $this->configuration = array(
      ...
      'auth_class'    => 'BKAP_Google_Auth_OAuth2',
      'io_class'      => self::USE_AUTO_IO_SELECTION,
      'cache_class'   => 'BKAP_Google_Cache_File',
      'logger_class'  => 'BKAP_Google_Logger_Null',
      ...
      'classes' => array(
        'BKAP_Google_IO_Abstract' => array(
          'request_timeout_seconds' => 100,
        ),
        'BKAP_Google_Logger_Abstract' => array(
          'level' => 'debug',
          'log_format' => "[%datetime%] %level%: %message% %context%\n",
          'date_format' => 'd/M/Y:H:i:s O',
          'allow_newlines' => true
        ),
        'BKAP_Google_Logger_File' => array(
          'file' => 'php://stdout',
          'mode' => 0640,
          'lock' => false,
        ),
        'BKAP_Google_Http_Request' => array(
        ...
        'BKAP_Google_Service_Exception' => array(
          'retry_map' => array(
        ...
        'BKAP_Google_IO_Exception' => array(
        ...
        'BKAP_Google_Cache_File' => array(
          'directory' => sys_get_temp_dir() . '/BKAP_Google_Client'
        )
      ),
    );
