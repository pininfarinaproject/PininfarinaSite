 ...
 */
class BKAP_Google_Cache_Memcache extends BKAP_Google_Cache_Abstract
{
  ...
  public function __construct(BKAP_Google_Client $client)
  {
    if (!function_exists('memcache_connect') && !class_exists("Memcached")) {
      ...
      throw new BKAP_Google_Cache_Exception($error);
    }
  ...
  public function set($key, $value)
  {
    ...
    if ($rc == false) {
      ...
      throw new BKAP_Google_Cache_Exception("Couldn't store data in cache");
    }
