 ...
 */
class BKAP_Google_Cache_File extends BKAP_Google_Cache_Abstract
{
  ...
  public function delete($key)
  {
    ...
    if (file_exists($file) && !unlink($file)) {
      ...
      throw new BKAP_Google_Cache_Exception("Cache file could not be deleted");
    }
  ...
  private function getCacheDir($file, $forWrite)
  {
    ...
    if ($forWrite && ! is_dir($storageDir)) {
      if (! mkdir($storageDir, 0755, true)) {
        ...
        throw new BKAP_Google_Cache_Exception("Could not create storage directory: $storageDir");
      }
    }
    return $storageDir;
  }
