...
<tr>
	...
	<td>
		<label class="bkap_switch">
			<input type="checkbox" class="bkap_checkbox" name="wc_booking_availability_bookable[]" value="1" <?php checked( ( isset( $availability['bookable'] ) ? $availability['bookable'] : 0 ), true ); ?> />
